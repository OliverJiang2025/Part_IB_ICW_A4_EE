...
absorber_mass = 0.5/num_absorbers;  % Assigning a small mass to each absorber
num_absorbers
absorber_frequency_shift
...
for i = 1:num_absorbers
    ...
    K(2, 2) = K(2, 2) + absorber_stiffness;
    new_column = [0; -absorber_stiffness; zeros(N+i-3, 1)];
